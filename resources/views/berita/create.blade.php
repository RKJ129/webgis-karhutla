                                ...
                                <form action="{{ route('berita.store') }}" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="tanggal" id="tanggal"
                                            ...
                                            id="lokasi_kejadian" value="{{ old('tanggal') }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul"
                                            ...
                                            id="judul" placeholder="Masukkan judul ... " value="{{ old('judul') }}"
                                            required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="lampiran" id="lampiran" rows="5" class="form-control @error('lampiran') is-invalid @enderror">{{ old('lampiran') }}</textarea>
