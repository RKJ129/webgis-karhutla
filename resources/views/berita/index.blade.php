                                  ...
                                  @foreach ($dataBerita as $data )
                                    <tr>
                                      ...
                                      <td class="text-center d-flex" >
                                        <div class="mx-0">
                                            <a href="{{ route('berita.edit',['id'=>$data->id]) }}">
                                        ...
                                        <div class="mx-0">
                                            ...
                                            <form action="{{ route('berita.destroy',['id'=>$data->id]) }}" class=' inline-block'method="POST" onsubmit=" return confirm('Are you sure want to delete this item?')">
                                            @csrf
                                            @method('DELETE')
